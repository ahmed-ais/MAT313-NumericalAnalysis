...
int main() {
    ...
    for (int i = 0; i < n; ++i) {
        ...
        double x1_next = (b[0] - a[0][1]*x2 - a[0][2]*x3) / a[0][0];
        double x2_next = (b[1] - a[1][0]*x1 - a[1][2]*x3) / a[1][1];
        double x3_next = (b[2] - a[2][0]*x1 - a[2][1]*x2) / a[2][2];
        
        // update x = (x1,x2,x3) with the new values
        x1 = x1_next; x2 = x2_next; x3 = x3_next;
    }
